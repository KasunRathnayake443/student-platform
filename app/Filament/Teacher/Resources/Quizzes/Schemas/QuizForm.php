    ...
    public static function configure(Schema $schema): Schema
    {
        return $schema
            ->components([
                ...
                /*
                 * The quiz always stays in its class. All teachers assigned
                 * to it (creator included) may manage and review it.
                 */
                Section::make('Class & Teachers')
                    ->description('Select the teachers responsible for this quiz.')
                    ->schema([
