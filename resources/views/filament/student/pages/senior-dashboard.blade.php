...
<div class="sd-wrap">
    ...
    <div class="sd-sidebar">
        <div class="sd-logo">📚 Student Portal</div>
        <nav class="sd-nav">
            <a href="#" class="sd-nav-item active">
                <svg class="sd-nav-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6"/></svg>
                Dashboard
            </a>
            <a href="#" class="sd-nav-item">
                <svg class="sd-nav-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.746 0 3.332.477 4.5 1.253v13C19.832 18.477 18.246 18 16.5 18c-1.746 0-3.332.477-4.5 1.253"/></svg>
                My Classes
            </a>
            <a href="#" class="sd-nav-item">
                <svg class="sd-nav-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2"/></svg>
                Assignments
            </a>
            <a href="#" class="sd-nav-item">
                <svg class="sd-nav-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8.228 9c.549-1.165 2.03-2 3.772-2 2.21 0 4 1.343 4 3 0 1.4-1.278 2.575-3.006 2.907-.542.104-.994.54-.994 1.093m0 3h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>
                Quizzes
            </a>
            <a href="#" class="sd-nav-item">
            ...
            <a href="#" class="sd-nav-item">
                <svg class="sd-nav-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z"/></svg>
                Profile
            </a>
        </nav>

        {{-- School context switcher in sidebar --}}
        <div class="sd-contexts">
            <div class="sd-ctx-label">Active Contexts</div>
            @if($allContexts)
                @foreach($allContexts as $schoolGroup)
                    @foreach($schoolGroup['contexts'] as $ctx)
                        ...
                        <div
                            ...
                            class="sd-ctx-pill {{ $isActive ? 'active' : '' }}"
                        >
                            <span>{{ Str::limit($schoolGroup['school']->name, 18) }}</span>
                            <span class="sd-ctx-grade">{{ $ctx['grade']->name ?? '' }}</span>
                        </div>
                    @endforeach
                @endforeach
            @endif
